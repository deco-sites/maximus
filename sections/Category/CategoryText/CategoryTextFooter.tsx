  ...
  return (
    <>
      {text && (
        <p
          ...
          class={`w-full max-w-[1200px] mx-auto my-8 text-base font-normal leading-6 tracking-[0px] text-[#171413] text-center ${
            showMore ? "max-h-[2000px]" : "max-h-[95px]"
      ...
      <button
        ...
        className="block mx-auto mt-5 text-sm font-normal leading-6 tracking-[0] text-white px-5 py-2 rounded-[3px] border-[none] bg-[#171413]"
      >
