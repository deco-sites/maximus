...
export default function Benefits(
  ...
  const {
    benefits = [{
      ...
      content:
        "<h3 class='text-lg text-center font-bold mb-5'>Política de Frete Grátis</h3><p class='text-sm font-normal leading-6'><strong>Paraná:</strong> Frete grátis para pedidos acima de R$ 199,00</p><p class='text-sm font-normal leading-6'><strong>Sul e Sudeste: </strong> Frete grátis para pedidos acima de R$ 299,00</p><p class='text-sm font-normal leading-6'><strong>Todo Brasil: </strong>Frete grátis para pedidos acima de R$ 499,00</p><p class='text-sm font-normal leading-6'>O serviço de entrega será escolhido automaticamente de acordo com o pedido (peso e cubagem) o CEP de destino. Reservamo-nos ao direito de alterar a politica de frete grátis sem aviso prévio.*Essa política de frete grátis é válida apenas para os produtos das maximus tecidos. As lojas de terceiros que vendem produtos em nosso site como bordado, manequins pet e máquinas de costura não obedecem a mesma política.</p>",
    }, {
