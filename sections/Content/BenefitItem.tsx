  ...
  return (
   <div class="flex items-center px-4 py-3 border border-[#eeeeee] rounded-[16px] max-md:min-w-max">
    <div class="flex-none">
        ...
        <div onClick={() => open.value = true} class="cursor-pointer flex-auto flex flex-col gap-1 lg:gap-2">
          <div
    ...
    >
      <div class="w-full" dangerouslySetInnerHTML={{
              __html: benefit.content,
            }}></div>
            <span class='w-full bg-black text-white font-normal rounded min-h-[42px] items-center flex justify-center cursor-pointer text-sm uppercase mt-[25px]' onClick={() => open.value = false}>entendi</span>
      </Modal>
   </div>
  );
}
